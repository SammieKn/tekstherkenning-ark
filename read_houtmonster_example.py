...
def main():
    ...
    tables = [parsed_pdf.result.tables[31]]  # Houtmonster tables
    houtmonsters = Houtmonster.from_doc_tables(tables)

    for houtmonster in houtmonsters:
        print(houtmonster.codering)
